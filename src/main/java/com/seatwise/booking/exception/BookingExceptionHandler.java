...
public class BookingExceptionHandler {
  ...
  public ResponseEntity<BookingStatusResponse> bookingResultHandler(BookingException e) {
    ...
    return ResponseEntity.status(status).body(BookingStatusResponse.pending(e.getRequestId()));
  }
}
